...
function __construct()
	...
	public function prosesAdd()
	{
      ...
      public function viewPDF($id_arsip)
      {
            $data = array(
                  'title' => 'View PDF',
                  'arsip' => $this->arsip_m->get_data_arsipId($id_arsip),
              );
              $this->template->load('template','arsip/arsip_viewpdf', $data);
      }

      // public function viewPDF($id_arsip)
      // {
      //    $data['arsip'] = $this->arsip_m->get_data_arsipId($id_arsip);
      //    $this->template->load('template','arsip/arsip_data',$data);
      //    $this->load->view('arsip/arsip_viewpdf',$data);
      // }
